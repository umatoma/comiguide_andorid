...
public class Comic1Circle {
    ...
    private int mId = -1;
    private int mComic1Id = -1;
    private int mC1layoutId = -1;
    ...
    private Comic1Layout mComic1Layout;

    public Comic1Circle(JSONObject circle) throws JSONException {
        mId = circle.getInt("id");
        mComic1Id = circle.getInt("comic1_id");
        mC1layoutId = circle.getInt("c1layout_id");
    ...
    public int getComic1Id() {
        return mComic1Id;
    }

    public int getC1layoutId() {
        return mC1layoutId;
    }
    ...
    public String getSpaceInfo() {
        Comic1Layout layout = mComic1Layout;
        Comic1Block block = layout.getComic1Block();
    ...
    public Comic1Layout getComic1Layout() {
        return mComic1Layout;
    }
